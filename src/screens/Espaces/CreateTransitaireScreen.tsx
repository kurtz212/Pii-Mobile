  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      <View style={styles.headerRow}>
        ...
        <Text style={styles.headerTitle}>Nouvel espace transitaire</Text>
        <View style={{ width: 20 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Ex. Faso Transit International"
        ...
        <View style={styles.categoryWrap}>
          {SERVICES.map((v) => {
            const active = services.includes(v);
            return (
              <Pressable
                key={v}
                style={[styles.categoryChip, active && styles.categoryChipActive]}
                onPress={() => toggleService(v)}
              >
        ...
        <Text style={styles.label}>Zones / pays couverts</Text>
        <TextInput
          style={styles.input}
          placeholder="Ex. Burkina Faso, Côte d'Ivoire, Ghana"
          placeholderTextColor={colors.textMuted}
          value={zonesCouvertes}
          onChangeText={setZonesCouvertes}
        />

        <Text style={styles.label}>Description</Text>
        <TextInput
          style={[styles.input, styles.textarea]}
          placeholder="Présente ton expertise, tes délais moyens de traitement..."
          placeholderTextColor={colors.textMuted}
          value={description}
        ...
        <View style={styles.infoNote}>
          ...
          <Text style={styles.infoText}>
            Une fois l'espace créé, les clients pourront te contacter directement pour une
            demande de devis sur leurs formalités de transport.
          </Text>
        </View>
        ...
        <View style={styles.subscriptionNote}>
          ...
          <Text style={styles.subscriptionText}>
            La création d'un espace transitaire active un abonnement compte pro. Le détail des
